...
$row = getDataRow (leerParam('id','0'), 'aliados');
?>
          ...
          <div class="col s12 m12">
            ...
            <div class="row">
              <div class="input-field col s12">
                <input name="data-title" id="data-title" type="text" value="<?php if(!empty($row['data-title'])) echo $row['data-title']?>" class="validate" required />
                <label for="data-title">Nombre</label>
              </div>
            </div>
            ...
            <div class="row">
              <div class="file-field input-field col s12 m6">
                ...
                <div class="file-path-wrapper">
                  <input value="<?php if(!empty($row['data-image'])) echo $HOSTPATH.$row['data-image'];?>" class="file-path validate" type="text" placeholder="Imagen del aliado" required />
                </div>
              </div>
              <div class="input-field col s12 m6">
                ...
                <label for="data-image-alt">Descripcion de Imagen del Aliado</label>
              </div>
            </div>
...
(function($){
  $(function(){
    ...
    saveForm('<?php echo $HOSTPATH;?>/core/saveAliado.php', '<?php echo $HOSTPATH;?>/admin/aliados/');
