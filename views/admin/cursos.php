  ...
  <main id="sticky-footer">
    <div class="container">
            ...
            <tbody class="js-content-table">
              <?php foreach ($rows as $keyrow => $row): ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo $HOSTPATH.'/admin/cursos/edit/?id='.$row['id'];?>" class="option-edit">
                      <i class="material-icons">edit</i>
                    </a>
                    <a href="<?php echo $HOSTPATH.'/core/delCurso.php?id='.$row['id'];?>" class="option-delete">
      ...
      <div class="fixed-action-btn save-button">
        <a href="<?php echo $HOSTPATH;?>/admin/cursos/edit/?id=0" class="btn-floating btn-large waves-effect waves-light pink"><i class="material-icons">add</i></a>
      </div>
