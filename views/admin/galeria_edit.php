...
$row = getDataRow (leerParam('id','0'), 'galeria');
?>
          ...
          <div class="col s12 m12">
            ...
            <div class="row">
              <div class="input-field col s12">
                <input name="data-date" id="data-date" type="date" value="<?php if(!empty($row['data-date'])) echo $row['data-date']?>" class="datepicker validate" required />
                <label for="data-date">Fecha</label>
              </div>
            </div>
...
(function($){
  $(function(){
    ...
    saveForm('<?php echo $HOSTPATH;?>/core/saveGaleria.php', '<?php echo $HOSTPATH;?>/admin/galeria/');
