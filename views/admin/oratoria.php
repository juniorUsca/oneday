  ...
  <main id="sticky-footer">
    <div class="container">
      <form id="content-form" action="#">
        <!-- HIDDEN INPUT FORM -->
        <input value="oratoria" name="data-page-form" type="hidden" /> <!-- END HIDDEN INPUT FORM -->
        <!-- SEO SECTION -->
          ...
          <div class="col s12 m12">
            ...
            <div class="row">
              <div class="input-field col s12">
                <input value="<?php echo getData('data-seo-title','oratoria');?>" name="data-seo-title" id="data-seo-title" type="text" class="validate" length='<?php echo $seo_title_size;?>'>
            ...
            <div class="row">
              <div class="input-field col s12">
                <textarea id="data-seo-description" name="data-seo-description" class="materialize-textarea" length='<?php echo $seo_description_size;?>'><?php echo getData('data-seo-description','oratoria');?></textarea>
            ...
            <div class="row">
              <div class="input-field col s12">
                <textarea id="data-seo-keywords" name="data-seo-keywords" class="materialize-textarea" length='<?php echo $seo_keywords_size;?>'><?php echo getData('data-seo-keywords','oratoria');?></textarea>
          ...
          <div class="col s12 m12">
            ...
            <div class="row">
              <div class="input-field col s12 m6">
                <input value="<?php echo getData('data-tab-name','oratoria');?>" name="data-tab-name" id="data-tab-name" type="text" class="validate">
                <label for="data-tab-name">Nombre de Pestaña</label>
              </div>
              <div class="input-field col s12 m6">
                <input value="<?php echo getData('data-tab-color','oratoria');?>" name="data-tab-color" id="data-tab-color" type="text" class="validate">
            ...
            <div class="row">
              <div class="input-field col s12 m6">
                <input value="<?php echo getData('data-banner-title','oratoria');?>" name="data-banner-title" id="data-banner-title" type="text" class="validate">
                <label for="data-banner-title">Titulo del Banner</label>
              </div>
              <div class="input-field col s12 m6">
                <input value="<?php echo getData('data-banner-subtitle','oratoria');?>" name="data-banner-subtitle" id="data-banner-subtitle" type="text" class="validate">
            ...
            <div class="row">
              <div class="file-field input-field col s12 m6">
                <div class="btn">
                  <img class="prev-img" src="<?php echo $HOSTPATH.getData('data-banner-image','oratoria');?>" />
                  <input name="data-banner-image" id="data-banner-image" type="file">
                </div>
                <div class="file-path-wrapper">
                  <input value="<?php echo get_url_end(getData('data-banner-image','oratoria'));?>" class="file-path validate" type="text" placeholder="Banner">
                </div>
              </div>
              <div class="input-field col s12 m6">
                <input value="<?php echo getData('data-banner-image-alt','oratoria');?>" name="data-banner-image-alt" id="data-banner-image-alt" type="text" class="validate">
            ...
            <div class="row">
              <div class="file-field input-field col s12 m6">
                <div class="btn">
                  <img class="prev-img" src="<?php echo $HOSTPATH.getData('data-banner-icono','oratoria');?>" />
                  <input name="data-banner-icono" id="data-banner-icono" type="file">
                </div>
                <div class="file-path-wrapper">
                  <input value="<?php echo get_url_end(getData('data-banner-icono','oratoria'));?>" class="file-path validate" type="text" placeholder="Banner">
                </div>
              </div>
              <div class="input-field col s12 m6">
                <input value="<?php echo getData('data-banner-icono-alt','oratoria');?>" name="data-banner-icono-alt" id="data-banner-icono-alt" type="text" class="validate">
...
(function($){
  $(function(){
    ...
    saveForm('<?php echo $HOSTPATH;?>/core/savePageContent.php', '<?php echo $HOSTPATH;?>/admin/oratoria/', {
