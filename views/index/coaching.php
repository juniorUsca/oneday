...
<head>
  ...
  <title><?php echo getData('data-seo-title','coaching');?></title>
  <link rel="icon" href="<?php echo $static;?>/imgs/logo_q.png" />
  <meta name="description" content="<?php echo getData('data-seo-description','coaching');?>" />
  <meta name="keywords" content="<?php echo getData('data-seo-keywords','coaching');?>" />
  ...
  <style>
    nav ul li.active {
      background-color: <?php echo getData('data-tab-color','coaching');?>;
    }
  </style>
</head>
<body>
  
  <?php $CURRENT_TAB = "coaching";?>
  ...
  <div id="index-banner" class="parallax-container index-banner">
        ...
        <div class="row" style="margin-bottom: 0;">
          ...
          <div class="col s12 m6 l5 offset-l1">
              <h3 class="header left">
                <?php echo getData('data-banner-title','coaching');?>
              </h3>
              <div class="row left">
                <h5 class="header col s12">
                  <?php echo getData('data-banner-subtitle','coaching');?>
                </h5>
              </div>
              <div class="row left">
                <figure style="width: 100px; margin: 12px;">
                  <img src="<?php echo $HOSTPATH.getData('data-banner-icono','coaching');?>" alt="<?php echo getData('data-banner-icono-alt','coaching');?>" class="responsive-img" />
                </figure>
              </div>
          </div>
    ...
    <div class="parallax"><img src="<?php echo $HOSTPATH.getData('data-banner-image','coaching');?>" alt="<?php echo getData('data-banner-image-alt','coaching');?>"></div>
  </div>
